...
public class ObjectDescriptor implements Cloneable {
	...
	public static final class Equipment {
		/**
		 * Convenience factory-method for simple equipment.
		 * @param slot Equipment slot
		 * @return Equipment descriptor with the given deployment-slot
		 */
		public static Equipment create(DeploymentSlot slot) {
			final Equipment equipment = new Equipment();
			equipment.slot = slot;
			return equipment;
		}

		private DeploymentSlot slot = DeploymentSlot.MAIN_HAND;
		private boolean two;
	...
	protected ObjectDescriptor(ObjectDescriptor descriptor) {
		this(descriptor.name, descriptor.props, descriptor.chars, descriptor.equipment.orElse(null));
	}
	 ...
	 */
	public final Optional<Equipment> getEquipment() {
		return equipment;
	}
	...
	public static class Builder {
		 ...
		 * @param equipment Equipment descriptor
		 */
		public Builder equipment(Equipment equipment) {
			this.equipment = Check.notNull(equipment);
			return this;
		}

		/**
		 * Convenience method for simple equipment.
		 * @param slot Deployment slot
		 * @see Equipment#create(DeploymentSlot)
		 */
		public Builder slot(DeploymentSlot slot) {
			return equipment(Equipment.create(slot));
		}
	...
	/**
	 * Builder for an equipment descriptor.
	 */
	public static class EquipmentBuilder {
		 ...
		 * @param slot Deployment slot
		 */
		public EquipmentBuilder slot(DeploymentSlot slot) {
			equipment.slot = Check.notNull(slot);
			return this;
		}
		 ...
		 */
		public EquipmentBuilder twoHanded(boolean two) {
			equipment.two = two;
			return this;
		}
		 ...
		 */
		public EquipmentBuilder condition(Condition condition) {
			equipment.condition = Check.notNull(condition);
			return this;
		}
		 ...
		 */
		public EquipmentBuilder armour(int armour) {
			equipment.armour = Check.zeroOrMore(armour);
			return this;
		}
		 ...
		 */
		public EquipmentBuilder passive(Effect.Descriptor passive) {
			equipment.passive = Check.notNull(passive);
			return this;
		}
