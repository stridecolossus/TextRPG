 ...
 * @author Sarge
 */
public class ObjectManager implements Contents.Listener {
	/**
	 ...
	 */
	public ObjectManager(LootFactory factory, Parent parent, int count, long reset) {
	...
	@Override
	public void contentsChanged(boolean add, Thing obj) {
