...
public class RaceLoader {
	...
	public Race load(TextNode node) {
		...
		for(ObjectDescriptor descriptor : equipment) {
			final DeploymentSlot slot = descriptor.getEquipment().getDeploymentSlot().orElseThrow(() -> node.exception("Cannot be equipped: " + descriptor));
