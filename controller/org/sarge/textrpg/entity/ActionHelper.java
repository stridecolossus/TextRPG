...
public final class ActionHelper {
	...
	public static void kill(Entity e) {
		...
		if(race.isCorporeal()) {
			...
			int weight = 10; // TODO - table from ctx
	 ...
	 * @param parent	Parent
	 * @param other		Other parent for portal events or <tt>null</tt>
	 * @param obj		Openable object
	 * @param key		Notification key
	 */
	public static void registerOpenableEvent(EventQueue queue, Location loc, Location other, WorldObject obj, String key) {
		// Create reset event
		...
		// Note event
		model.getEventHolder().set(entry);
	}
}
