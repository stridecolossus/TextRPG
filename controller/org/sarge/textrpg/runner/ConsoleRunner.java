...
//			out.flush();
	...
	public static void main(String[] args) throws Exception {
		...
		ctx.add(Portal.QUEUE);
		ctx.add(Light.QUEUE);
		ctx.add(Control.QUEUE);
		ctx.add(RevealObject.QUEUE);
		ctx.add(Shop.QUEUE);
		ctx.add(ObjectFactory.QUEUE);
		ctx.add(MoveableLocation.QUEUE);
