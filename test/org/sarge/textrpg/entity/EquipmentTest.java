...
public class EquipmentTest extends ActionTest {
	...
	public void before() {
		...
		obj = new Builder("object").weight(2).slot(SLOT).armour(3).build().create();
	}
	...
	public void equipTwoHanded() throws ActionException {
		final WorldObject other = new Builder("off.hand").slot(DeploymentSlot.OFF_HAND).twoHanded(true).build().create();
		equipment.equip(obj);
