...
public final class Description {
	 ...
	 */
	public static String wrap(Object arg) {
		return Util.wrap(arg.toString().toLowerCase(), "{", "}");
	}
	...
	public static class Builder {
		 ...
		 * @param value
		 */
		public Builder wrap(String key, Object value) {
			add(key, Description.wrap(value));
			return this;
		}
